...
for CONFIG in "${BIT_CONFIGS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$CUDA_DEVICES python ptq.py \
        ...
        --w_bits $W_BIT --a_bits $A_BIT --k_bits 16 --v_bits 16 \
        --k_asym --v_asym --a_asym --k_groupsize 128 --v_groupsize 128 \
        --rotate --distribute --deactivate_r2 --wikitext2 --w_rtn --lm_eval --lm_eval_batch_size 16 --w_clip \
    ...
    CUDA_VISIBLE_DEVICES=$CUDA_DEVICES python ptq.py \
        ...
        --w_bits $W_BIT --a_bits $A_BIT --k_bits 16 --v_bits 16 \
        --k_asym --v_asym --a_asym --k_groupsize 128 --v_groupsize 128 \
        --rotate --distribute --deactivate_r1 --online_r2 --wikitext2 --w_rtn --w_clip --lm_eval --lm_eval_batch_size 16 \
