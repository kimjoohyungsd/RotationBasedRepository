...
for i in "${!MODELS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$GPU_ID python ptq.py \
        ...
        --rotate   --deactivate_r2 --wikitext2 --w_rtn --w_clip > "/home/jhkcool97/RotationBasedRepository/outputs/log_${MODEL_NAME}_{No_R2}.txt" 2>&1 &
...
for i in "${!MODELS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$GPU_ID python ptq.py \
        ...
        --w_bits 4 --a_bits 4 --k_bits 16 --v_bits 16 \
        --k_asym --v_asym --k_groupsize 128 --v_groupsize 128 \
        --rotate  --online_r2 --wikitext2 --w_rtn --w_clip > "/home/jhkcool97/RotationBasedRepository/outputs/log_${MODEL_NAME}_{R2}.txt" 2>&1 &
